...
5. 警惕"万能主题"陷阱：如果某个已有主题的名字本身很宽泛笼统、没有具体指向（比如"未分类""其他""杂项""随想"这类），不要因为它"什么都能装得下"就把碎片塞进去——这类宽泛主题只有在碎片本身也确实找不到任何具体主题方向时才使用。只要碎片有哪怕一点具体的主题倾向，就应该新建一个更具体的主题，或归入其他真正相关的具体主题，而不是图省事塞进笼统主题。
6. 新建主题时，标题本身也绝不能是"未分类""其他""杂项""随想""笔记"这类没有具体指向的万能标签——这种标签会变成一个吸走所有后续碎片的黑洞，等于没有分类。如果实在看不出碎片的具体主题方向，就直接用碎片本身的关键内容/原文措辞当标题，也不要发明一个笼统的分类名词。
...
4. 警惕"万能主题"陷阱：如果当前主题本身的名字很宽泛笼统、没有具体指向（比如"未分类""其他""杂项""随想"这类），不要仅仅因为"什么都能装得下"就一律判定适合——只要碎片有哪怕一点具体的主题倾向（跟"其他已有主题"里某个更具体的主题相关，或者足够独立成一个新主题），就应该判定不适合，让它去更合适的地方。

如果判定不适合，需要给出更合适的去向——这个产品的核心目的是防止想法过度分散在太多主题里，所以：
- 优先从"其他已有主题"里选一个合理关联的（哪怕关联很松散），而不是新建主题——但同样要避开宽泛笼统的"万能主题"，除非确实没有更具体的选择。
- 只有确实和所有已有主题都无关时，才新建主题，且新主题要宽泛，不要为单条碎片开一个过窄的新主题。
- 新建主题的标题本身也绝不能是"未分类""其他""杂项""随想""笔记"这类没有具体指向的万能标签——这种标签会变成一个吸走所有后续碎片的黑洞。如果实在看不出具体主题方向，就直接用碎片本身的关键内容/原文措辞当标题。
